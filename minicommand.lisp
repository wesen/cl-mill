...
(defun frontplate-element (&key name package x y angle)
  (with-named-pass ("frontplate")
    (cond #-nil((or (string= package "3FTL06")
							 (string= package "3FTL06-LED"))
					 (when *frontplate-top*
					...
					((string= package "JOYSTICK")
					 (goto-abs :x (- x 6.3) :y (- y 9.4))
					 (rectangle-inline 14 13 :depth *frontplate-depth*)
					 #+nil(drill :x x :y y :diameter 23 :depth *frontplate-depth*))
					#+nil((string= package "CI-11")
					 (when *frontplate-top*
						 (drill :x x :y y :diameter 7.5 :depth *frontplate-depth*)))
					#+nil((string= package "LED5MM")
					 (when *frontplate-top*
						 (drill :x x :y y :diameter 5.5 :depth *frontplate-depth*)))
					#+nil((string= package "POWER")
					 (when *frontplate-top*
						 ;; orig
						 (progn
